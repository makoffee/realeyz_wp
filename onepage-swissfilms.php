<?php
/*
 * Template Name: SWISSFILMS Landing Page
 */
get_header();
?>
<?php

	// checking menu exist in location "swissfilms"
	if(  ( $locations = get_nav_menu_locations() ) && $locations['swissfilms'] )
	{
		$menu 			= wp_get_nav_menu_object( $locations['swissfilms'] );
