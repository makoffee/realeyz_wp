<?php
/*
 * Template Name: critic.de Landing Page
 */
get_header();
?>
<?php

	// checking menu exist in location "critic.de"
	if(  ( $locations = get_nav_menu_locations() ) && $locations['critic.de'] )
	{
		$menu 			= wp_get_nav_menu_object( $locations['critic.de'] );
